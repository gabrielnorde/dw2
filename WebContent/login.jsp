            ...
            <section class="register-form container">
                ...
                <form method="post" action="controle" name="register-form" id="register-form" class="register-form">
                    ...
                    <div class="register-input-div">
                        ...
                        <input id="name" name="login" type="text" value="" required="required ">
                        <label class="register-label-author"> Username:*</label>
                    </div>
    
                    <div class="register-input-div">
                        <span class="form-field-register-message form-field-cpf-message"></span>
                        <input id="cpf" name="senha" type="password" value=""required="required">
                        <label class="register-label-cpf"> Senha:*</label>
                    </div>
                    <input type=hidden name=comando value=login
					<button class="form-submit-button"> Logar     </button>        		    
                </form>
